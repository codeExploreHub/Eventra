...
```text
python3 -B -m tools.multica.knowledge curate --project-id __FRONTEND_PROJECT_ID__ --backend-project-id __BACKEND_PROJECT_ID__ --curator-agent-id __KNOWLEDGE_CURATOR_AGENT_ID__ --apply
```
